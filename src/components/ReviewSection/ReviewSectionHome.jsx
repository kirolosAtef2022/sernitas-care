      ...
      <div className="container flex flex-col md:flex-row items-center justify-center gap-8">
        ...
        <div className="relative flex-shrink-0">
          <CachedImage
            ...
            className="w-48 h-48 md:w-56 md:h-56 rounded-full object-cover border-2 border-primary-500"
          />
          {/* Play Button */}
          <button
            className="absolute bottom-[5px] -right-2 transform -translate-x-1/2 bg-primary-500 text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform "
