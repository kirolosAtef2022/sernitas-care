    ...
    <div className="bg-slate-100">
      <div className="container py-24 px-6 lg:px-12 xl:px-44">
        ...
        <motion.h1
          ...
          whileInView="animate"
          viewport={{ once: true }}
          className="font-sour text-3xl xl:text-4xl font-bold text-center text-primary-500 mb-12"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {cardsData.map((card, index) => (
            <motion.div
              ...
              whileInView="animate"
              viewport={{ once: true }}
              className="bg-primary-500 shadow-2xl rounded-2xl px-4 py-10 text-center flex flex-col justify-between items-center md:max-w-[350px] mx-auto min-h-[400px]"
            >
              {/* Icon */}
              <CachedImage
                src={card.image}
